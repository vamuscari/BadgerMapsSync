...
func TestEndpoints(t *testing.T) {
	// Create a new Endpoints instance with a test base URL
	baseURL := "https://test-api.example.com/api/2"
	...
	// Test Customers
	expected := "https://test-api.example.com/api/2/customers/"
	...
	// Test Customer
	expected = "https://test-api.example.com/api/2/customers/123/"
	...
	// Test Routes
	expected = "https://test-api.example.com/api/2/routes/"
	...
	// Test Route
	expected = "https://test-api.example.com/api/2/routes/456/"
	...
	// Test Appointments
	expected = "https://test-api.example.com/api/2/appointments/"
	...
	expected = "https://test-api.example.com/api/2/appointments/?customer_id=789"
	...
	// Test Appointment
	expected = "https://test-api.example.com/api/2/appointments/101"
	...
	// Test Profiles
	expected = "https://test-api.example.com/api/2/profiles/"
	...
	// Test Profile
	expected = "https://test-api.example.com/api/2/profiles/202"
	...
	// Test Locations
	expected = "https://test-api.example.com/api/2/locations/"
	...
	// Test Location
	expected = "https://test-api.example.com/api/2/locations/303"
	...
	// Test SearchUsers
	expected = "https://test-api.example.com/api/2/search/users/?q=john"
	...
	// Test SearchAccounts
	expected = "https://test-api.example.com/api/2/search/accounts/?q=acme"
	...
	expected = "https://test-api.example.com/api/2/search/locations/?q=san+francisco"
	...
	// Test SearchProfiles
	expected = "https://test-api.example.com/api/2/search/profiles/?q=smith"
	...
	// Test DataSets
	expected = "https://test-api.example.com/api/2/data_sets/"
	...
	// Test DataSet
	expected = "https://test-api.example.com/api/2/data_sets/404"
	...
	// Test DataSetValues
	expected = "https://test-api.example.com/api/2/data_set_values/"
	...
	// Test DataSetValue
	expected = "https://test-api.example.com/api/2/data_set_values/505"
	...
	// Test Waypoints
	expected = "https://test-api.example.com/api/2/waypoints/"
	...
	// Test Waypoint
	expected = "https://test-api.example.com/api/2/waypoints/606"
	...
	expected = "https://test-api.example.com/api/2/waypoints/?route_id=707"
